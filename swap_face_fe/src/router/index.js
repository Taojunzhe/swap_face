...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: '/swap_face_task',
      name: 'swap_face_task',
      component: () => import(/* webpackChunkName: "swap_face" */ '../views/SwapFace.vue')
    },
    {
      path: '/topic_manager',
      name: 'topic_manager',
      component: () => import(/* webpackChunkName: "topic_manager" */ '../views/TopicManager.vue'),
    },
    {
      path: '/topic_manager/detail',
      name: 'topic_manager_detail',
      component: () => import(/* webpackChunkName: "topic_detail_manager" */ '../views/TopicDetailManager.vue'),
    }
  ]
})
